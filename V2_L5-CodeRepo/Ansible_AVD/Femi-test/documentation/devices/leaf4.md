...
| Ethernet7 | SERVER_host3_Ethernet4 | *access | *30 | *- | *- | 7 |
| Ethernet8 | SERVER_host4_Ethernet4 | *access | *40 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet6 | - | 10.34.1.25/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet6 | - | 10.34.1.27/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet6 | - | 10.34.1.29/31 | default | 1550 | False | - | - |
| Ethernet6 | P2P_spine4_Ethernet6 | - | 10.34.1.31/31 | default | 1550 | False | - | - |
...
!
interface Ethernet7
   description SERVER_host3_Ethernet4
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description SERVER_host4_Ethernet4
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.10.4.4/32 |
...
| Vlan3009 |  VRF_Internal  |  10.255.251.5/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.34.1.24 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.34.1.26 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.34.1.28 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.34.1.30 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_Internal | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 60 | 10.10.4.4:10060 | 10060:10060 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_Internal | 10.10.4.4:10 | connected |
...
router bgp 65299
   ...
   neighbor 10.34.1.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.34.1.24 remote-as 65001
   neighbor 10.34.1.24 description spine1_Ethernet6
   neighbor 10.34.1.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.34.1.26 remote-as 65001
   neighbor 10.34.1.26 description spine2_Ethernet6
   neighbor 10.34.1.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.34.1.28 remote-as 65001
   neighbor 10.34.1.28 description spine3_Ethernet6
   neighbor 10.34.1.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.34.1.30 remote-as 65001
   neighbor 10.34.1.30 description spine4_Ethernet6
